<template>
  <div>
    ...
    <div class="tool-box">
      <span @click="drawingLineModeSwitch('line')"
      ...
      <span @click="drawingLineModeSwitch('arrow')"
      ...
      <span @click="drawingLineModeSwitch('thinTailArrow')"
        :class="state.isDrawingLineMode && state.lineType === 'thinTailArrow' && 'bg'">
        <svg t="1715323097309" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="24572" width="20" height="20">
          <path
